...
ACLOCAL = ${SHELL} /data/data/io.neoterm/files/usr/tmp/libssh2-1.9.0/missing aclocal-1.16
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /data/data/io.neoterm/files/home/aria2//toolchain/bin/ar
AS = as
AUTOCONF = ${SHELL} /data/data/io.neoterm/files/usr/tmp/libssh2-1.9.0/missing autoconf
AUTOHEADER = ${SHELL} /data/data/io.neoterm/files/usr/tmp/libssh2-1.9.0/missing autoheader
AUTOMAKE = ${SHELL} /data/data/io.neoterm/files/usr/tmp/libssh2-1.9.0/missing automake-1.16
AWK = awk
CC = /data/data/io.neoterm/files/home/aria2//toolchain/bin/clang
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2
CPP = /data/data/io.neoterm/files/home/aria2//toolchain/bin/clang -E
CPPFLAGS = -I/data/data/io.neoterm/files/home/aria2//usr/local//include
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = dlltool
...
ECHO_N = -n
ECHO_T = 
EGREP = /data/data/io.neoterm/files/usr/bin/applets/grep -E
EXEEXT = 
FGREP = /data/data/io.neoterm/files/usr/bin/applets/grep -F
GREP = /data/data/io.neoterm/files/usr/bin/applets/grep
HAVE_LIBBCRYPT = 
HAVE_LIBCRYPT32 = 
HAVE_LIBGCRYPT = 
HAVE_LIBMBEDCRYPTO = 
HAVE_LIBSSL = yes
HAVE_LIBZ = yes
INSTALL = /data/data/io.neoterm/files/usr/bin/applets/install -c
INSTALL_DATA = ${INSTALL} -m 644
INSTALL_PROGRAM = ${INSTALL}
INSTALL_SCRIPT = ${INSTALL}
INSTALL_STRIP_PROGRAM = $(install_sh) -c -s
LD = /data/data/io.neoterm/files/home/aria2//toolchain/bin/ld
LDFLAGS = 
LIBBCRYPT = 
LIBBCRYPT_PREFIX = 
LIBCRYPT32 = 
...
LIBSSH2VER = 1.9.0
LIBSSL = /data/data/io.neoterm/files/home/aria2//usr/local//lib/libssl.so /data/data/io.neoterm/files/home/aria2//usr/local//lib/libcrypto.so -Wl,-rpath -Wl,/data/data/io.neoterm/files/home/aria2//usr/local//lib
LIBSSL_PREFIX = 
LIBTOOL = $(SHELL) $(top_builddir)/libtool
LIBZ = /data/data/io.neoterm/files/home/aria2//usr/local/lib/libz.a
LIBZ_PREFIX = 
LIPO = 
LN_S = ln -s
LTLIBBCRYPT = 
...
LTLIBMBEDCRYPTO = 
LTLIBOBJS = 
LTLIBSSL = -L/data/data/io.neoterm/files/home/aria2//usr/local//lib -lssl -L/data/data/io.neoterm/files/home/aria2//usr/local//lib -lcrypto -R/data/data/io.neoterm/files/home/aria2//usr/local//lib
LTLIBZ = -L/data/data/io.neoterm/files/home/aria2//usr/local/lib -lz
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} /data/data/io.neoterm/files/usr/tmp/libssh2-1.9.0/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = ./install-sh -c -d
NM = /data/data/io.neoterm/files/home/aria2//toolchain/bin/nm -B
NMEDIT = 
OBJDUMP = objdump
OBJEXT = o
OTOOL = 
...
PACKAGE_VERSION = -
PATH_SEPARATOR = :
RANLIB = /data/data/io.neoterm/files/home/aria2//toolchain/bin/ranlib
SED = /data/data/io.neoterm/files/home/aria2//toolchain/bin/sed
SET_MAKE = 
SHELL = /bin/sh
SSHD = /data/data/io.neoterm/files/usr/bin/sshd
STRIP = /data/data/io.neoterm/files/home/aria2//toolchain/bin/strip
VERSION = -
abs_builddir = /data/data/io.neoterm/files/usr/tmp/libssh2-1.9.0
abs_srcdir = /data/data/io.neoterm/files/usr/tmp/libssh2-1.9.0
abs_top_builddir = /data/data/io.neoterm/files/usr/tmp/libssh2-1.9.0
abs_top_srcdir = /data/data/io.neoterm/files/usr/tmp/libssh2-1.9.0
ac_ct_AR = 
ac_ct_CC = /data/data/io.neoterm/files/home/aria2//toolchain/bin/clang
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /data/data/io.neoterm/files/usr/tmp/libssh2-1.9.0/install-sh
...
pdfdir = ${docdir}
prefix = /data/data/io.neoterm/files/home/aria2//usr/local
